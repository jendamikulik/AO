...
# -*- coding: utf-8 -*-
"""
Mistrovská verze AO_GEO_resonance_full.py
- Sjednocená implementace všech pokročilých principů.
- DIMACS parser.
- Schedule: lock-only double coprime stride (T=L*R, R=ceil(cR*log n)), two-pass varianta.
- Walsh–Hadamard (Sylvester) generátor s Walsh/sequency pořadím + ořez.
...
Autor: JAN MIKULIK
Sjednocení: Jan Mikulik a AI (ChatGPT & Grok)

Jak to hned použít (krátké recepty)
1) Benchmark (najde τ* mezi uf/uuf):
python FULL1.py bench uf250-098.cnf uf250-099.cnf uf250-0100.cnf \
...
# pevný práh
python FULL1.py classify uf250-098.cnf uuf250-098.cnf \
